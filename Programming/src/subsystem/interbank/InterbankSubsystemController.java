...
public class InterbankSubsystemController {
	...
	private static final String SECRET_KEY = " BLAbP13xw3Y=";
	private static final String PAY_COMMAND = "pay";
	private static final String REFUND_COMMAND = "refund";
	private static final String VERSION = "1.0.0";
	private static final String APP_CODE = "siFCCmLBYA==";
	...
	public PaymentTransaction refund(CreditCard card, int amount, String contents) {
		...
		Map<String, Object> hmap = new MyMap();
		hmap.put("secretKey", SECRET_KEY);
		hmap.put("transaction", transaction);
	
		String hcode = Utils.md5(generateData(hmap)); 
